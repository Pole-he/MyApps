/*
 * Copyright 2012 Evgeny Shishkin Licensed under the Apache License, Version 2.0
...
package com.nathan.myapps.app.msg;
...
class MsgManager extends Handler {
    ...
    private void displayMsg() {
        ...
        if (appMsg.getActivity() == null || appMsg.getActivity().isFinishing()) {
            msgQueue.poll();
        }
        final Message msg;
        if (!appMsg.isShowing()) {
            ...
            sendMessageDelayed(msg,
                    appMsg.getDuration() + inAnimation.getDuration() + outAnimation.getDuration());
        }
    }
