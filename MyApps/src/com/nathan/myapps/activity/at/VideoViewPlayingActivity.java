...
public class VideoViewPlayingActivity extends Activity implements OnPreparedListener,
        OnCompletionListener, OnErrorListener, OnInfoListener, OnPlayingBufferCacheListener {
    ...
    private void initUI() {
         ...
         * 设置ak及sk的前16位
         */
        BVideoView.setAKSK("s4vBXXOhalluI6bjTRE1PGO0", "UmXye3oDpeW7bj4HTUf9Aihyl7jzMEIE");
