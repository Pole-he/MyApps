...
/*
 * Implementation Notes: Some terminology: index - index of the items that are
 * currently visible position - index of the items in the cursor
 */
...
public class PLA_ListView extends PLA_AbsListView {
    ...
    private View fillSpecific(int position, int top) {
        ...
        if (DEBUG)
            Logger.d("PLA_ListView", "FillSpecific: " + position + ":" + top);
    ...
    protected void onFocusChanged(boolean gainFocus, int direction, Rect previouslyFocusedRect) {
        ...
        if (DEBUG)
            Logger.v("PLA_ListView", "onFocusChanged");
    ...
    /*
     * (non-Javadoc) Children specified in XML are assumed to be header views.
     * After we have parsed them move them out of the children list and into
     * mHeaderViews.
     */
    @Override
