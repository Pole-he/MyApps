...
JNIEXPORT void JNICALL Java_com_nathan_myapps_bitmap_StackBlurManager_functionToBlur(JNIEnv* env, jobject obj, jobject bitmapIn, jobject bitmapOut, jint radius) {
