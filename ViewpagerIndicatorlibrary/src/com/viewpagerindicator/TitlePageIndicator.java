/*
 * Copyright (C) 2011 Jake Wharton Copyright (C) 2011 Patrik Akerfeldt Copyright
 * (C) 2011 Francisco Figueiredo Jr. Licensed under the Apache License, Version
...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        mLinePosition = LinePosition.fromValue(a.getInteger(
                R.styleable.TitlePageIndicator_linePosition, defaultLinePosition));
        mTopPadding = a.getDimension(R.styleable.TitlePageIndicator_topPadding, defaultTopPadding);
        mTitlePadding = a.getDimension(R.styleable.TitlePageIndicator_titlePadding,
                defaultTitlePadding);
        mClipPadding = a.getDimension(R.styleable.TitlePageIndicator_clipPadding,
                defaultClipPadding);
        mColorSelected = a.getColor(R.styleable.TitlePageIndicator_selectedColor,
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if ((bound.left > left && bound.left < right)
                ...
                canvas.drawText(pageTitle, 0, pageTitle.length(), bound.left, bound.bottom
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (heightSpecMode == MeasureSpec.EXACTLY) {
            ...
            height = mBounds.bottom - mBounds.top + mFooterLineHeight + mFooterPadding
                    + mTopPadding;
