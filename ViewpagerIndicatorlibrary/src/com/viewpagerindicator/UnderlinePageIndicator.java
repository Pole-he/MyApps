/*
 * Copyright (C) 2012 Jake Wharton Licensed under the Apache License, Version
...
public class UnderlinePageIndicator extends View implements PageIndicator {
    ...
    public UnderlinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        setSelectedColor(a.getColor(R.styleable.UnderlinePageIndicator_selectedColor,
                defaultSelectedColor));
        setFadeDelay(a.getInteger(R.styleable.UnderlinePageIndicator_fadeDelay, defaultFadeDelay));
        setFadeLength(a
                .getInteger(R.styleable.UnderlinePageIndicator_fadeLength, defaultFadeLength));
